...
class ServerSideDubbingServiceImpl implements IDubbingService {
  static final ServerSideDubbingServiceImpl _instance = ServerSideDubbingServiceImpl._internal();
  factory ServerSideDubbingServiceImpl() => _instance;
  ServerSideDubbingServiceImpl._internal();

  @override
  void cancelDubbing(String videoId, String videoUrl) => cancel(videoId);
  ...
  Stream<DubbingResult> dubVideo(
    ...
    // Unify targetLanguage mapping (the endpoint expects 'english' or another language)
    return requestDub(videoId, targetLanguage: targetLang);
  }
