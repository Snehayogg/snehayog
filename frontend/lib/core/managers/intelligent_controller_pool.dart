...
class IntelligentControllerPool {
  ...
  static const int _basePoolSize = 3; // Base pool size for current video
  static const int _preloadPoolSize = 2; // Pool size for preloading
  static const int _maxTotalControllers = 5; // Maximum total controllers
  static const int _maxConcurrentInitializations =
      2; // Max concurrent initializations
